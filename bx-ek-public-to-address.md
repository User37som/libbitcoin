...
EK_PUBLIC_KEY        The encrypted public key from which to extract the  
                     ...
                     from STDIN.    
```
**WARNING:** despite the term "confirmation code" this value should never be used for confirmation. It is included as a command for completeness only. Instead confirm using [ek-to-address](bx-ek-to-address) or [ek-to-ec](bx-ek-to-ec). For more information see [BIP38 Security Considerations](https://github.com/libbitcoin/libbitcoin/wiki/BIP38-Security-Considerations).

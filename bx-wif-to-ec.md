...
> Examples 2 and 3 show that the compression flag is carried in the WIF, independently of the secret key. The compression flag is only used when the public key is exposed.
...
The [settings](bx-settings) command outputs all settings and default values. When a path is specified on the command line or by environment variable, the values are populated accordingly.
